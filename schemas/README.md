...
```yaml
# yaml-language-server: $schema=./node_modules/@browserflow-ai/core/schemas/spec-v2.schema.json
version: 2
name: my-test
steps:
  - id: step-1
...
```yaml
# yaml-language-server: $schema=./node_modules/@browserflow-ai/core/schemas/browserflow.schema.json
project:
  name: my-project
...
{
  "yaml.schemas": {
    "./node_modules/@browserflow-ai/core/schemas/spec-v2.schema.json": "specs/**/*.yaml",
    "./node_modules/@browserflow-ai/core/schemas/browserflow.schema.json": "browserflow.yaml"
  }
}
```
...
2. Add a new mapping:
   - Schema file: `node_modules/@browserflow-ai/core/schemas/spec-v2.schema.json`
