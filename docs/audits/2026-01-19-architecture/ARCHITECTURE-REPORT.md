...
```mermaid
graph LR
  cli["@browserflow-ai/cli"] --> core["@browserflow-ai/core"]
  exploration["@browserflow-ai/exploration"] --> core
  generator["@browserflow-ai/generator"] --> core
  reviewUI["@browserflow-ai/review-ui"] --> core
